...
public class LBComboRegsitry {
    ...
    public static final RegistryObject<ComboState> HP = COMBO_STATES.register("heart_slash",
            ComboState.Builder.newInstance().startAndEnd(400, 459).priority(50)
                    ...
                    .addTickAction(ComboState.TimeLineTickAction.getBuilder()
                            ...
                            .put(6, (entityIn) -> AttackManager.doSlash(entityIn, 180F, Vec3.ZERO, false, false, SlashEffectUtils.addslashbladesaDamage(entityIn,1)))
                            .put(7, (entityIn) -> Drive.doSlash(entityIn,45,20,Vec3.ZERO,false,SlashEffectUtils.addslashbladesaDamage(entityIn,1),1F))
                            .build())
                    .addHitEffect(StunManager::setStun)
                    ::build);
    ...
    public static final RegistryObject<ComboState> greedyGrip = COMBO_STATES.register("greedy_grip",
            ComboState.Builder.newInstance().startAndEnd(400, 459).priority(50)
                    ...
                    .addTickAction(ComboState.TimeLineTickAction.getBuilder()
                            ...
                            .put(2, (entityIn) -> DriveSumon.doSlash(entityIn, 45F, 20, Vec3.ZERO, false,10, 1f, 1f, 2, SlashbladeUtils.getcolor(entityIn)))
                            ...
                            .put(4, (entityIn) -> DriveSumon.doSlash(entityIn, -45F, 20, Vec3.ZERO, false, 10, 1f, 1f, 2,SlashbladeUtils.getcolor(entityIn)))
                            .put(5, JudgementCut::doJudgementCutJust)
    ...
    public static final RegistryObject<ComboState> flurry  = COMBO_STATES.register("flurry",
            ComboState.Builder.newInstance().startAndEnd(400, 459).priority(50)
                    ...
                    .addTickAction(ComboState.TimeLineTickAction.getBuilder()
                            .put(1, (entityIn) -> AttackManager.doSlash(entityIn, 30F, Vec3.ZERO, false, false, SlashEffectUtils.addslashbladesaDamage(entityIn,1)))
                            .put(2, (entityIn) -> DriveSumon.doSlash(entityIn, 45F, 20, Vec3.ZERO, false, 5, 1f, 1f, 2, SlashbladeUtils.getcolor(entityIn)))
                            .put(3, (entityIn) -> DriveSumon.doSlash(entityIn, -45F, 20, Vec3.ZERO, false,5, 1f, 1f, 2, SlashbladeUtils.getcolor(entityIn)))
                            .put(4, (entityIn) -> DriveSumon.doSlash(entityIn, 90F, 20, Vec3.ZERO, false, 5, 1f, 1f, 2,SlashbladeUtils.getcolor(entityIn)))
                            .put(5, (entityIn) -> DriveSumon.doSlash(entityIn, 45F, 20, Vec3.ZERO, false, 5, 1f, 1f, 2, SlashbladeUtils.getcolor(entityIn)))
                            .put(6, (entityIn) -> DriveSumon.doSlash(entityIn, -45F, 20, Vec3.ZERO, false,5, 1f, 1f, 2, SlashbladeUtils.getcolor(entityIn)))
                            .put(7, (entityIn) -> DriveSumon.doSlash(entityIn, 90F, 20, Vec3.ZERO, false, 5, 1f, 1f, 2,SlashbladeUtils.getcolor(entityIn)))
                            .put(8, (entityIn) -> DriveSumon.doSlash(entityIn, 45F, 20, Vec3.ZERO, false, 5, 1f, 1f, 2, SlashbladeUtils.getcolor(entityIn)))
                            .put(9, (entityIn) -> DriveSumon.doSlash(entityIn, -45F, 20, Vec3.ZERO, false, 5, 1f, 1f, 2, SlashbladeUtils.getcolor(entityIn)))
                            .put(10, (entityIn) -> DriveSumon.doSlash(entityIn, 90F, 20, Vec3.ZERO, false, 5, 1f, 1f, 2,SlashbladeUtils.getcolor(entityIn)))
    ...
    public static final RegistryObject<ComboState> swordone = COMBO_STATES.register("swordone",
            ComboState.Builder.newInstance().startAndEnd(400, 459).priority(50)
                    ...
                    .addTickAction(ComboState.TimeLineTickAction.getBuilder()
                            ...
                            .put(2, (entity)-> Swordone.doSlash(entity,false,10,2F,Vec3.ZERO))
                            .build())
                    .addHitEffect(StunManager::setStun)
                    ::build);
    ...
    public static final RegistryObject<ComboState> SAKURA_END_LEFTEX = COMBO_STATES.register("sakura_end_left_ex",
            ComboState.Builder.newInstance().startAndEnd(1816, 1859).speed(6F).priority(50)
                    ...
                    .addTickAction(ComboState.TimeLineTickAction.getBuilder()
                            .put(1, (entityIn) -> Drive.doSlash(entityIn,22.5F,10,Vec3.ZERO,false,SlashEffectUtils.addslashbladesaDamage(entityIn,3),8F))
                            .build())
    ...
    public static final RegistryObject<ComboState> SAKURA_END_RIGHTEX = COMBO_STATES.register("sakura_end_right_ex",
            ComboState.Builder.newInstance().startAndEnd(204, 218).speed(1.1F).priority(50)
                    ...
                    .addTickAction(ComboState.TimeLineTickAction.getBuilder()
                            .put(1, (entityIn) -> Drive.doSlash(entityIn,180F - 22.5F,10,Vec3.ZERO,false,SlashEffectUtils.addslashbladesaDamage(entityIn,3),8F))
                            .build())
            ...
            ComboState.Builder.newInstance().startAndEnd(720, 743).priority(100)
                    ...
                    .addTickAction(ComboState.TimeLineTickAction.getBuilder()
                            .put(12 - 3, (entityIn) -> AttackManager.doSlash(entityIn, 0,
                                    new Vec3(entityIn.getRandom().nextFloat() - 0.5f, 0.8f, 0), false, true, SlashEffectUtils.addslashbladesaDamage(entityIn,4)))
                            .put(13 - 3, (entityIn) -> AttackManager.doSlash(entityIn, 5,
                                    new Vec3(entityIn.getRandom().nextFloat() - 0.5f, 0.8f, 0), true, false, SlashEffectUtils.addslashbladesaDamage(entityIn,4)))
                            .build())
                    .addTickAction(ComboState.TimeLineTickAction.getBuilder()
                            .put(1, (entityIn) -> Drive.doSlash(entityIn,180F,10,Vec3.ZERO,false,SlashEffectUtils.addslashbladesaDamage(entityIn,2),8F))
