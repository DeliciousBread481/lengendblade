...
//	public static final DeferredRegister<Item> REGISTRY = DeferredRegister.create(ForgeRegistries.ITEMS, MODID);
	...
	public static final ItemEntry<TooltipItem> whiteButterfly;
	public static final ItemEntry<TooltipItem> god_soul_crystal;
	public static final ItemEntry<Item> god;
	public static final ItemEntry<Item> godex;
	static {
		...
		whiteButterfly=iteminit("whitebutterfly","Diedie Funeral Ceremony");
		god_soul_crystal=iteminit("god_soul_crystal",
				"Align the knife on the knife hanging table and use it to increase three values for the knife"
		);
		god=iteminit("god");
		godex=iteminit("godex");
}
