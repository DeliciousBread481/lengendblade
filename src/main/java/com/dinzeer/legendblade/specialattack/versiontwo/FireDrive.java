...
import com.dinzeer.legendblade.entity.DriveSummonEntityFire;
...
public class FireDrive {
    public static void doSlash(LivingEntity playerIn, float roll, int lifetime, Vec3 centerOffset,
        ...
        doSlash(playerIn, roll, lifetime, centerOffset, critical, damage, KnockBacks.cancel, minSpeed, maxSpeed, count,0);
    ...
    public static void doSlash(LivingEntity playerIn, float roll, int lifetime, int colorCode, Vec3 centerOffset,
                ...
                .add(playerIn.getLookAngle().scale(centerOffset.z));
        {
            ...
            DriveSummonEntityFire drive = new DriveSummonEntityFire(LBEntiteRegristrys.fd, playerIn.level());
