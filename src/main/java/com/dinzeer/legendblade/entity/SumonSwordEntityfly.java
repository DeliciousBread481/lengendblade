...
public class SumonSwordEntityfly extends absNeoSummonSword {
    private static final EntityDataAccessor<Boolean> IT_FIRED = SynchedEntityData.defineId(SumonSwordEntityfly.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Float> SPEED = SynchedEntityData.defineId(SumonSwordEntityfly.class, EntityDataSerializers.FLOAT);

    private static final EntityDataAccessor<Vector3f> OFFSET = SynchedEntityData.defineId(SumonSwordEntityfly.class, EntityDataSerializers.VECTOR3);
    long fireTime = -1;

    public SumonSwordEntityfly(EntityType<? extends Projectile> entityTypeIn, Level worldIn) {
        super(entityTypeIn, worldIn);

        this.setPierce((byte) 5);
    }

    public static SumonSwordEntityfly createInstance(PlayMessages.SpawnEntity packet, Level worldIn) {
        return new SumonSwordEntityfly(LBEntiteRegristrys.ssexfly, worldIn);
    }
