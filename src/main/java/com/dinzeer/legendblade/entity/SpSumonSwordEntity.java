...
public class SpSumonSwordEntity extends absNeoSummonSword {
    ...
    {
        return new SpSumonSwordEntity(LBEntiteRegristrys.sps, worldIn);
    }
    ...
    protected void onHitEntity(EntityHitResult result)
    {
        ...
        if (targetEntity instanceof LivingEntity lv) {
            lv.heal((float) (40+2*(getHeal()+this.getDamage())));
        }
