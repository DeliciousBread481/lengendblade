...
public class BulletEntity extends absNeoSummonSword {
    private static final EntityDataAccessor<Boolean> IT_FIRED = SynchedEntityData.defineId(BulletEntity.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Float> SPEED = SynchedEntityData.defineId(BulletEntity.class, EntityDataSerializers.FLOAT);

    private static final EntityDataAccessor<Vector3f> OFFSET = SynchedEntityData.defineId(BulletEntity.class, EntityDataSerializers.VECTOR3);
    long fireTime = -1;

    public BulletEntity(EntityType<? extends Projectile> entityTypeIn, Level worldIn)
    {
    ...
    public static BulletEntity createInstance(PlayMessages.SpawnEntity packet, Level worldIn)
    {
        return new BulletEntity(LBEntiteRegristrys.be, worldIn);
    }
