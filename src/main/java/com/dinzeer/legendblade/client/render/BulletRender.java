...
@OnlyIn(Dist.CLIENT)
public class BulletRender<T extends EntityAbstractSummonedSword> extends EntityRenderer<T> {
    private static final ResourceLocation TEXTURE = Legendblade.prefix("model/util/ss.png");
    private static final ResourceLocation MODEL = Legendblade.prefix("model/util/bullet.obj");
